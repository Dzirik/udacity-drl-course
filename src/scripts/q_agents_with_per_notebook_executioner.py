...
NETWORKS = ["Q"]  # ["DUEL-Q"], ["Q", "DUEL-Q"]
DROPOUTS = [True]  # [True, False]
EPS_DECAYS = [0.995]
GAMMAS = [0.99]
STEPS_UPDATES = [
    (4, 8), (4, 16),
            ...
            for gamma in GAMMAS:
                for step_update in STEPS_UPDATES:
                    DEFAULT_LIST_OF_PARAMS.append({
                        ...
                        "EPS_DECAY": eps_decay,
                        "GAMMA": gamma,
                        "UPDATE_EVERY_STEP": step_update[0],
                        "HARD_UPDATE_EVERY_STEPS": step_update[1],
                        "ALPHA": ALPHA,
                        "BETA_STAR": BETA_START
                    })

DEFAULT_NTB_PATH = "../../notebooks/final/02_double_q_agent_with_PER_training.ipynb"
DEFAULT_OUTPUT_FOLDER = "E:/DATA/RL/reports"
...
if __name__ == "__main__":
    ...
    CONFIG_NAME = "python_local"  # None
    NOTEBOOK_NAME = "Q_AGENT_PER_"
