...
CREATE_BUTTON = False
ADDAPT_WIDTH = False
NOTEBOOK_NAME = "02_double_q_agent_training"#get_notebook_name()
...
# +
ENV_ID = "CartPole-v1" # "LunarLander-v2" "CartPole-v1" 
...
# +
agent = DQNAgent(env, ACTIONS_DIM, MEMORY_SIZE, BATCH_SIZE, net, GAMMA)

# agent.set_optimizing_parameters(update_every_steps=STEPS_UPDATE[0], hard_update_every_steps=[1], tau=0.001)
agent.set_optimizing_parameters(update_every_steps=UPDATE_EVERY_STEP, hard_update_every_steps=HARD_UPDATE_EVERY_STEPS, 
                                tau=0.001)
